		...
		<div id="primary" class="content-area">
			<main id="main" class="site-main" role="main">
                ...
                <div class="issue-header wire-header">
                    <div class="wire-title-super">Newsletter Name</div>
                ...
                <div class="issue_template_content_section">
                    ...
                    $newsletterPosts = get_field('newsletter_name_posts');
                    if ($newsletterPosts) : ?>
                                ...
                                <div class="wire-grid-item wire-post">
                                    <a href="<?php echo $permalink . '?current_site=9'; ?>">
                                        <div class="feature-image">
                                            ...
                                            $thumbnail_img_url = get_field('newsletter_name_post_thumbnail');
