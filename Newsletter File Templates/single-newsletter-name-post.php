    ...
    <div class="child-page">
        <div id="primary" class="content-area">
            <main id="main" class="site-main" role="main">
             ...
             <?php //get issue
             $issueTerms = get_the_terms( get_the_ID(), 'newsletter-name-issue-group' );
                ...
                <div class="issue_template_right_section">
                    ...
                    <div id="primary" class="issue_template_content_section">
                        ...
                        <div class="news-links">
                            <?php previous_post_link( '%link', 'Previous post in Issue', TRUE, ' ', 'newsletter-name-issue-group' ); ?><?php next_post_link( '%link', 'Next post in Issue', TRUE, ' ', 'newsletter-name-issue-group' ); ?>
                        </div>
