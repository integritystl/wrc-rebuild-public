    ...
    <div id="primary" class="content-area wire-page">
        <main id="main" class="site-main" role="main">
            ...
            <div class="wire-grid-container">
                ...
                $issue_count = wp_count_posts('wrcagency-newsletter')->publish;
                ?>
            ...
            <?php if ($issue_count >= 5) { ?>
                <a href="/wrcagency-newsletter/" class="post_item_read_more">WRC Agency Newsletter <i class="fa fa-caret-right" aria-hidden="true"></i></a>
            <?php } ?>
        </main><!-- #main -->
    </div><!-- #primary -->
</div>
