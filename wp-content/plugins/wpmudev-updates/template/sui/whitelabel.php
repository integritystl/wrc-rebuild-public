...
$url_upgrade_to_agency = sprintf( '%s%s', $urls->remote_site, '/hub/account/?level=full-unlimited-site&quantity=1#checkout' );
...
<?php
$can_use_whitelabel = ( is_wpmudev_member() && 'full-1-site' !== $membership_data['membership_full_level'] )
	|| 'unit' === $membership_data['membership'];
?>
